 ...
 * @param text_idle_color Idle text color
 * @param text_hover_color Hover text color
 * @param text_active_color Active text color
 * @param idle_color Idle background color
 * @param hover_color Hover background color
 * @param active_color Active background color
 */
